...
int DataClass::getIndex() { return this->index; }
...
std::string* DataClass::getName() { return &(this->name); }

// sets the name of the class, returns previous name
void DataClass::setName(std::string* newName) { name = *newName; }

// gets the number of sets in this class
int DataClass::getSetNumber() const { return sets.size(); }

// gets the sets in the class
std::vector<int>* DataClass::getSetsInClass() { return &sets; }
