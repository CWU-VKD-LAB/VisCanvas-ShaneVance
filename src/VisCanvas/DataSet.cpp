...
int DataSet::getClass() const { return setClass; }
...
int DataSet::getIndex() const { return currentIndex; }
...
int DataSet::getOriginalIndex() const { return originalIndex; }

// gets the name of the set
std::string* DataSet::getName() { return &(this->name); }

// sets the name returns previous name
void DataSet::setName(std::string& newName) { name = newName; }

// checks if the set is visible or not
bool DataSet::isVisible() { return visible; }
