...
class SetCluster {
 public:
  ...
  // dimensions
  SetCluster(ColorCustom& clusterColor, std::vector<int>* newSetsInCluster,
             std::vector<Dimension*>* dimensionToCalculateWith);
  // deletes object
  ~SetCluster();

  // gets the calculates the minimum value of dimension for the sets whose
  // indexes are passed(setIndexes)
  static double getMinimumValue(Dimension* dimension,
                                std::vector<int>* setIndexes);
  // gets the calculates the mean value of dimension for the sets whose indexes
  // are passed(setIndexes)
  static double getMeanValue(Dimension* dimension,
                             std::vector<int>* setIndexes);
  // gets the calculates the median value of dimension for the sets whose
  // indexes are passed(setIndexes)
  static double getMedianValue(Dimension* dimension,
                               std::vector<int>* setIndexes);
  // gets the calculates the maximum value of dimension for the sets whose
  // indexes are passed(setIndexes)
  static double getMaximumValue(Dimension* dimension,
                                std::vector<int>* setIndexes);
  ...
  void setAlphaTwo(double newAlphaTwo);
