...
namespace VisCanvas
{
  ...
  /// </summary>
public
  ref class AdditionalSettings : public System::Windows::Forms::Form
  {
  public:
  ...
  private:
    Nevron::Nov::WinFormControls::NColorBoxControl ^ nColorBoxControl1;
...
#pragma region Windows Form Designer generated code
    ...
    void InitializeComponent(void)
    {
      ...
      this->nColorBoxControl1->Location = System::Drawing::Point(218, 125);
...
#pragma endregion
  private:
    System::Void nColorBoxControl1_SelectedColorChanged(Nevron::Nov::Dom::NValueChangeEventArgs ^ arg)
    {
  ...
  private:
    System::Void radiusKeyPress(System::Object ^ sender, System::Windows::Forms::KeyPressEventArgs ^ e)
    {
  ...
  private:
    System::Void nButtonControl3_Click(Nevron::Nov::Dom::NEventArgs ^ arg)
    {
      ...
      OpenGL->file->setReadDimensionNames(this->checkBox2->Checked);
      OpenGL->file->setReadClassNames(this->checkBox3->Checked);
      OpenGL->file->setReadSetNames(this->checkBox4->Checked);
  ...
  private:
    System::Void AdditionalSettings_Load(System::Object ^ sender, System::EventArgs ^ e)
    {
