...
class Dimension {
 public:
  ...
  // gets the data calibrated, but not inverted or shifted data for the set of
  // the passed index(dataIndex)
  ...
  // multiplies all the data in the dimension by the passed double, does not
  // alter original data
