...
/// </summary>
public
ref class Settings : public System::Windows::Forms::Form {
 public:
 ...
 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl7;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl8;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl9;
 ...
 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl4;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl5;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl6;
 ...
 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl3;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl2;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl1;
 ...
 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl10;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl11;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl12;
 ...
 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl13;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl14;

 private:
  Nevron::Nov::WinFormControls::NButtonControl ^ nButtonControl15;
 ...
 private:
  Nevron::Nov::WinFormControls::NHsbColorPickerControl ^
...
#pragma region Windows Form Designer generated code
  ...
  void InitializeComponent(void) {
    ...
    this->nButtonControl7 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl8 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl9 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    ...
    this->nButtonControl4 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl5 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl6 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->tabPage2 = (gcnew System::Windows::Forms::TabPage());
    this->nHsbColorPickerControl1 =
        (gcnew Nevron::Nov::WinFormControls::NHsbColorPickerControl());
    ...
    this->nButtonControl3 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl2 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl1 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    ...
    this->nButtonControl13 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl14 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl15 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->tabPage4 = (gcnew System::Windows::Forms::TabPage());
    this->nHsbColorPickerControl2 =
        (gcnew Nevron::Nov::WinFormControls::NHsbColorPickerControl());
    ...
    this->nButtonControl10 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl11 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    this->nButtonControl12 =
        (gcnew Nevron::Nov::WinFormControls::NButtonControl());
    ...
    this->tabPage3->Click +=
        gcnew System::EventHandler(this, &Settings::tabPage3_Click);
    //
    // label27
    //
    this->label27->AutoSize = true;
    this->label27->Font = (gcnew System::Drawing::Font(
        L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Bold));
    ...
    this->textBox2->KeyPress +=
        gcnew System::Windows::Forms::KeyPressEventHandler(
            this, &Settings::textBox2_KeyPress_State);
    //
    // textBox1
    //
    ...
    this->textBox1->KeyPress +=
        gcnew System::Windows::Forms::KeyPressEventHandler(
            this, &Settings::textBox1_KeyPress_State);
    //
    // checkBox1
    //
    ...
    this->checkBox1->CheckedChanged +=
        gcnew System::EventHandler(this, &Settings::checkedDimension_State);
    //
    // dataGridView2
    //
    ...
    this->dataGridView2->Columns->AddRange(
        gcnew cli::array<System::Windows::Forms::DataGridViewColumn ^>(2){
            this->Column1, this->dataGridViewTextBoxColumn1});
    this->dataGridView2->Location = System::Drawing::Point(64, 184);
    this->dataGridView2->MultiSelect = false;
    this->dataGridView2->Name = L"dataGridView2";
    this->dataGridView2->RowHeadersVisible = false;
    this->dataGridView2->RowHeadersWidthSizeMode = System::Windows::Forms::
        DataGridViewRowHeadersWidthSizeMode::DisableResizing;
    this->dataGridView2->Size = System::Drawing::Size(201, 154);
    this->dataGridView2->TabIndex = 39;
    this->dataGridView2->CellValueChanged +=
        gcnew System::Windows::Forms::DataGridViewCellEventHandler(
            this, &Settings::dataGridView2_CellValueChanged);
    this->dataGridView2->EditingControlShowing += gcnew
        System::Windows::Forms::DataGridViewEditingControlShowingEventHandler(
            this, &Settings::dataGridView1_EditingControl);
    this->dataGridView2->KeyPress +=
        gcnew System::Windows::Forms::KeyPressEventHandler(
            this, &Settings::dataGridView2_KeyPressed_State);
    //
    // Column1
    //
    ...
    this->dataGridViewTextBoxColumn1->Resizable =
    ...
    this->comboBox3->SelectedIndexChanged += gcnew System::EventHandler(
        this, &Settings::comboBox3_SelectedIndexChanged);
    //
    // nButtonControl7
    //
    this->nButtonControl7->AutoSize = false;
    this->nButtonControl7->DesignTimeState =
        resources->GetString(L"nButtonControl7.DesignTimeState");
    ...
    this->nButtonControl7->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl7_Click);
    //
    // nButtonControl8
    //
    this->nButtonControl8->AutoSize = false;
    this->nButtonControl8->DesignTimeState =
        resources->GetString(L"nButtonControl8.DesignTimeState");
    ...
    this->nButtonControl8->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl8_Click);
    //
    // nButtonControl9
    //
    this->nButtonControl9->AutoSize = false;
    this->nButtonControl9->DesignTimeState =
        resources->GetString(L"nButtonControl9.DesignTimeState");
    ...
    this->nButtonControl9->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl9_Click);
    //
    // tabPage1
    //
    ...
    this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(
        this, &Settings::setClass_SelectedIndex_Change);
    //
    // label7
    //
    ...
    this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(
        this, &Settings::setSetIndexChanged_ChangeEvent);
    //
    // nButtonControl4
    //
    this->nButtonControl4->AutoSize = false;
    this->nButtonControl4->DesignTimeState =
        resources->GetString(L"nButtonControl4.DesignTimeState");
    ...
    this->nButtonControl4->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl4_Click);
    //
    // nButtonControl5
    //
    this->nButtonControl5->AutoSize = false;
    this->nButtonControl5->DesignTimeState =
        resources->GetString(L"nButtonControl5.DesignTimeState");
    ...
    this->nButtonControl5->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl5_Click);
    //
    // nButtonControl6
    //
    this->nButtonControl6->AutoSize = false;
    this->nButtonControl6->DesignTimeState =
        resources->GetString(L"nButtonControl6.DesignTimeState");
    ...
    this->nButtonControl6->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl6_Click);
    //
    // tabPage2
    //
    ...
    this->nHsbColorPickerControl1->SelectedColorChanged +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NValueChangeEventArgs ^>(
            this, &Settings::nHsbColorPickerControl1_SelectedColorChanged_1);
    //
    // panel1
    //
    ...
    this->panel1->BackColorChanged +=
        gcnew System::EventHandler(this, &Settings::changePanelColor);
    //
    // numericUpDown4
    //
    this->numericUpDown4->Location = System::Drawing::Point(267, 276);
    this->numericUpDown4->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown4->Name = L"numericUpDown4";
    this->numericUpDown4->Size = System::Drawing::Size(47, 20);
    this->numericUpDown4->TabIndex = 35;
    this->numericUpDown4->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown4->Value =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown4->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown4_ValueChanged);
    //
    // label14
    //
    this->label14->AutoSize = true;
    this->label14->Font =
        (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9));
    this->label14->Location = System::Drawing::Point(242, 277);
    ...
    // numericUpDown3
    //
    this->numericUpDown3->Location = System::Drawing::Point(267, 233);
    this->numericUpDown3->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown3->Name = L"numericUpDown3";
    this->numericUpDown3->Size = System::Drawing::Size(47, 20);
    this->numericUpDown3->TabIndex = 33;
    this->numericUpDown3->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown3->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown3_ValueChanged);
    //
    // numericUpDown2
    //
    this->numericUpDown2->Location = System::Drawing::Point(267, 190);
    this->numericUpDown2->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    ...
    this->numericUpDown2->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown2->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown2_ValueChanged);
    //
    // numericUpDown1
    //
    ...
    this->numericUpDown1->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown1->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown1_ValueChanged);
    //
    // label13
    //
    this->label13->AutoSize = true;
    this->label13->Font = (gcnew System::Drawing::Font(
        L"Microsoft Sans Serif", 12.5F, System::Drawing::FontStyle::Bold));
    ...
    this->label13->Text = L"+";
    this->label13->Click +=
        gcnew System::EventHandler(this, &Settings::label13_Click);
    this->label13->MouseLeave +=
        gcnew System::EventHandler(this, &Settings::classAddLeave);
    this->label13->MouseHover +=
        gcnew System::EventHandler(this, &Settings::classAddHover);
    //
    // label12
    //
    this->label12->AutoSize = true;
    this->label12->Font = (gcnew System::Drawing::Font(
        L"Microsoft Sans Serif", 6.75F, System::Drawing::FontStyle::Bold));
    ...
    this->label12->Click +=
        gcnew System::EventHandler(this, &Settings::label12_Click);
    this->label12->MouseLeave +=
        gcnew System::EventHandler(this, &Settings::classRemoveLeave);
    this->label12->MouseHover +=
        gcnew System::EventHandler(this, &Settings::classRemoveHover);
    //
    // label6
    //
    ...
    this->textBox5->TextChanged +=
        gcnew System::EventHandler(this, &Settings::textBox5_TextChanged);
    //
    // nButtonControl3
    //
    this->nButtonControl3->AutoSize = false;
    this->nButtonControl3->DesignTimeState =
        resources->GetString(L"nButtonControl3.DesignTimeState");
    ...
    this->nButtonControl3->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl3_Click);
    //
    // nButtonControl2
    //
    this->nButtonControl2->AutoSize = false;
    this->nButtonControl2->DesignTimeState =
        resources->GetString(L"nButtonControl2.DesignTimeState");
    ...
    this->nButtonControl2->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl2_Click);
    //
    // nButtonControl1
    //
    this->nButtonControl1->AutoSize = false;
    this->nButtonControl1->DesignTimeState =
        resources->GetString(L"nButtonControl1.DesignTimeState");
    ...
    this->nButtonControl1->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl1_Click);
    //
    // label5
    //
    ...
    this->label5->Font =
        (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9));
    this->label5->Location = System::Drawing::Point(242, 233);
    ...
    this->classComboBox->SelectedIndexChanged += gcnew System::EventHandler(
        this, &Settings::classComboBox_SelectedIndexChanged);
    //
    // tabControl1
    //
    ...
    this->comboBox5->SelectedIndexChanged += gcnew System::EventHandler(
        this, &Settings::classSetSelectedIndex_Changed);
    //
    // nButtonControl13
    //
    this->nButtonControl13->AutoSize = false;
    this->nButtonControl13->DesignTimeState =
        resources->GetString(L"nButtonControl13.DesignTimeState");
    ...
    this->nButtonControl13->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl13_Click);
    //
    // nButtonControl14
    //
    this->nButtonControl14->AutoSize = false;
    this->nButtonControl14->DesignTimeState =
        resources->GetString(L"nButtonControl14.DesignTimeState");
    ...
    this->nButtonControl14->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl14_Click);
    //
    // nButtonControl15
    //
    this->nButtonControl15->AutoSize = false;
    this->nButtonControl15->DesignTimeState =
        resources->GetString(L"nButtonControl15.DesignTimeState");
    ...
    this->nButtonControl15->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl15_Click);
    //
    // tabPage4
    //
    ...
    this->tabPage4->Click +=
        gcnew System::EventHandler(this, &Settings::tabPage4_Click);
    //
    // nHsbColorPickerControl2
    //
    ...
    this->nHsbColorPickerControl2->SelectedColorChanged +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NValueChangeEventArgs ^>(
            this, &Settings::nHsbColorPickerControl2_SelectedColorChanged_1);
    //
    // label24
    //
    ...
    this->label16->Click +=
        gcnew System::EventHandler(this, &Settings::label16_Click);
    this->label16->MouseLeave +=
        gcnew System::EventHandler(this, &Settings::removeCluster_Leave);
    this->label16->MouseHover +=
        gcnew System::EventHandler(this, &Settings::removeCluster_Hover);
    //
    // panel2
    //
    ...
    // numericUpDown5
    //
    this->numericUpDown5->Location = System::Drawing::Point(267, 246);
    this->numericUpDown5->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown5->Name = L"numericUpDown5";
    this->numericUpDown5->Size = System::Drawing::Size(47, 20);
    this->numericUpDown5->TabIndex = 57;
    this->numericUpDown5->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown5->Value =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown5->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown5_ValueChanged);
    //
    // label15
    //
    ...
    this->label15->Font =
        (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9));
    this->label15->Location = System::Drawing::Point(242, 247);
    this->label15->Name = L"label15";
    this->label15->Size = System::Drawing::Size(24, 15);
    this->label15->TabIndex = 56;
    this->label15->Text = L"A1:";
    //
    // numericUpDown6
    //
    this->numericUpDown6->Location = System::Drawing::Point(267, 213);
    this->numericUpDown6->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown6->Name = L"numericUpDown6";
    this->numericUpDown6->Size = System::Drawing::Size(47, 20);
    this->numericUpDown6->TabIndex = 55;
    this->numericUpDown6->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown6->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown6_ValueChanged);
    //
    // numericUpDown7
    //
    this->numericUpDown7->Location = System::Drawing::Point(267, 182);
    this->numericUpDown7->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown7->Name = L"numericUpDown7";
    this->numericUpDown7->Size = System::Drawing::Size(47, 20);
    this->numericUpDown7->TabIndex = 54;
    this->numericUpDown7->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown7->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown7_ValueChanged);
    //
    // numericUpDown8
    //
    this->numericUpDown8->Location = System::Drawing::Point(267, 148);
    this->numericUpDown8->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown8->Name = L"numericUpDown8";
    this->numericUpDown8->Size = System::Drawing::Size(47, 20);
    this->numericUpDown8->TabIndex = 53;
    this->numericUpDown8->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    this->numericUpDown8->ValueChanged += gcnew System::EventHandler(
        this, &Settings::numericUpDown8_ValueChanged);
    //
    // label19
    //
    ...
    this->label19->Font =
        (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9));
    this->label19->Location = System::Drawing::Point(242, 213);
    ...
    this->label20->Font =
        (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9));
    this->label20->Location = System::Drawing::Point(242, 182);
    ...
    this->comboBox4->SelectedIndexChanged += gcnew System::EventHandler(
        this, &Settings::comboBox4_SelectedIndexChanged);
    //
    // nButtonControl10
    //
    this->nButtonControl10->AutoSize = false;
    this->nButtonControl10->DesignTimeState =
        resources->GetString(L"nButtonControl10.DesignTimeState");
    ...
    this->nButtonControl10->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl10_Click);
    //
    // nButtonControl11
    //
    this->nButtonControl11->AutoSize = false;
    this->nButtonControl11->DesignTimeState =
        resources->GetString(L"nButtonControl11.DesignTimeState");
    ...
    this->nButtonControl11->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl11_Click);
    //
    // nButtonControl12
    //
    this->nButtonControl12->AutoSize = false;
    this->nButtonControl12->DesignTimeState =
        resources->GetString(L"nButtonControl12.DesignTimeState");
    ...
    this->nButtonControl12->Click +=
        gcnew Nevron::Nov::Function<Nevron::Nov::Dom::NEventArgs ^>(
            this, &Settings::nButtonControl12_Click);
    //
    // timer1
    //
    ...
    this->timer1->Tick +=
        gcnew System::EventHandler(this, &Settings::timer1_Tick);
    //
    // timer2
    //
    ...
    this->timer2->Tick +=
        gcnew System::EventHandler(this, &Settings::timer2_Tick);
    //
    // numericUpDown9
    //
    this->numericUpDown9->Location = System::Drawing::Point(267, 276);
    this->numericUpDown9->Maximum =
        System::Decimal(gcnew cli::array<System::Int32>(4){255, 0, 0, 0});
    this->numericUpDown9->Name = L"numericUpDown9";
    this->numericUpDown9->Size = System::Drawing::Size(47, 20);
    this->numericUpDown9->TabIndex = 64;
    this->numericUpDown9->TextAlign =
        System::Windows::Forms::HorizontalAlignment::Right;
    ...
    this->label28->Font =
        (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9));
    this->label28->Location = System::Drawing::Point(242, 277);
    this->label28->Name = L"label28";
    this->label28->Size = System::Drawing::Size(24, 15);
    this->label28->TabIndex = 63;
    this->label28->Text = L"A2:";
    //
    // Settings
    //
...
#pragma endregion
 private:
  System::Void nButtonControl2_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
 ...
 private:
  ...
  // Class tab OK button
 private:
  System::Void nButtonControl1_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyClass();
    this->Close();
  }

 private:
  System::Void redBox(System::Object ^ sender,
 ...
 private:
  System::Void nButtonControl5_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->Close();
  }

 private:
  System::Void nButtonControl8_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->Close();
  }

 private:
  System::Void nHsbColorPickerControl1_SelectedColorChanged(
      Nevron::Nov::Dom::NValueChangeEventArgs ^ arg) {
    Nevron::Nov::Graphics::NColor selectedColor =
        (Nevron::Nov::Graphics::NColor)arg->NewValue;
 ...
 private:
  ...
  std::string* toStandardString(System::String ^ str) {
    ...
    System::Runtime::InteropServices::Marshal::FreeHGlobal(
        IntPtr((void*)location));
    return temp;
  }

 private:
  System::Void comboBox3_SelectedIndexChanged(System::Object ^ sender,
                                              System::EventArgs ^ e) {
    if (OpenGL->uploadedFile()) {
      int currentIndex = this->comboBox3->SelectedIndex;
      System::String ^ temp = gcnew System::String(
          (*OpenGL->getDimensionName(currentIndex)).c_str());
 ...
 private:
  System::Void classComboBox_SelectedIndexChanged(System::Object ^ sender,
                                                  System::EventArgs ^ e) {
    if (OpenGL->uploadedFile()) {
      System::String ^ temp = gcnew System::String(
          (*OpenGL->getClassName(this->classComboBox->SelectedIndex)).c_str());
 ...
 private:
  System::Void Settings_Load(System::Object ^ sender, System::EventArgs ^ e) {
    ...
    // hypercube-cluster tab
    toolTip->SetToolTip(this->label21, "Red");
    toolTip->SetToolTip(this->label20, "Green");
    toolTip->SetToolTip(this->label19, "Blue");
    toolTip->SetToolTip(this->label15,
                        "Alpha 1 (Opacity) - Display of hypercube clusters");
    toolTip->SetToolTip(
        this->label28,
        "Alpha 2 (Opacity) - Display sets and hypercube clusters");
      ...
      if (this->comboBox2->Items->Count > 0) {
        ...
        if (this->comboBox1->Items->Count > 0) {
          this->comboBox1->SelectedIndex =
              OpenGL->getClassOfSet(this->comboBox2->SelectedIndex);
        }
      }
 ...
 private:
  System::Void checkBox1_CheckedChanged(System::Object ^ sender,
                                        System::EventArgs ^ e) {}

 private:
  System::Void tabPage3_Click(System::Object ^ sender, System::EventArgs ^ e) {}
 ...
 private:
  System::Void numericUpDown2_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    System::Decimal r = this->numericUpDown1->Value;
    System::Decimal g = this->numericUpDown2->Value;
    System::Decimal b = this->numericUpDown3->Value;
 ...
 private:
  System::Void numericUpDown3_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    System::Decimal r = this->numericUpDown1->Value;
    System::Decimal g = this->numericUpDown2->Value;
    System::Decimal b = this->numericUpDown3->Value;
 ...
 private:
  System::Void numericUpDown4_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    System::Decimal r = this->numericUpDown1->Value;
    System::Decimal g = this->numericUpDown2->Value;
    System::Decimal b = this->numericUpDown3->Value;
  ...
  // depricated
 private:
  System::Void changePanelColor(System::Object ^ sender,
                                System::EventArgs ^ e) {
    /* System::Decimal r = this->numericUpDown1->Value;
    System::Decimal g = this->numericUpDown2->Value;
    System::Decimal b = this->numericUpDown3->Value;
    System::Decimal a = this->numericUpDown4->Value;
    this->panel1->BackColor = System::Drawing::Color::FromArgb((int)a, (int)r,
    (int)g, (int)b); */
  }
 ...
 private:
  System::Void label13_Click(System::Object ^ sender, System::EventArgs ^ e) {
    if (OpenGL->uploadedFile()) {
      OpenGL->addClass();
      this->loadClass();
      this->classComboBox->SelectedIndex =
          this->classComboBox->Items->Count -
          1;  // set it to the last index and shows it
      System::String ^ temp = gcnew System::String(
          (*OpenGL->getClassName(this->classComboBox->Items->Count - 1))
              .c_str());
      this->textBox5->Text = temp;
    }
  }
 ...
 private:
  System::Void classAddHover(System::Object ^ sender, System::EventArgs ^ e) {
    this->label13->ForeColor = System::Drawing::Color::FromArgb(
        (int)45, (int)200, (int)0);  // somewhat dark green
  }

 private:
  System::Void classAddLeave(System::Object ^ sender, System::EventArgs ^ e) {
    this->label13->ForeColor = System::Drawing::Color::Black;
  }

 private:
  System::Void classRemoveHover(System::Object ^ sender,
                                System::EventArgs ^ e) {
    this->label12->ForeColor = System::Drawing::Color::FromArgb(
        (int)200, (int)0, (int)0);  // somewhat dark green
  }

 private:
  System::Void classRemoveLeave(System::Object ^ sender,
                                System::EventArgs ^ e) {
 ...
 protected:
  ...
  System::Void applyClass(System::Void) {
    if (OpenGL->uploadedFile()) {
      ...
      if (!className->empty() && currentIndex > 0) {
        ...
        this->textBox5->Text =
            gcnew System::String((*OpenGL->getClassName(currentIndex)).c_str());
      }
  ...
  System::Void applySet(System::Void) {
    if (OpenGL->uploadedFile()) {
      ...
      if (!setName->empty()) {
        ...
        this->loadSet();
        this->loadSetData(
            this->comboBox3->SelectedIndex);  // refresh the dimension names
        this->comboBox2->SelectedIndex = currentIndex;
      } else {
        this->textBox6->Text =
            gcnew System::String((*OpenGL->getSetName(currentIndex)).c_str());
      }
  ...
  System::Void applyDimension(System::Void) {
    if (OpenGL->uploadedFile()) {
      ...
      // may need to be improved because it updates every time accept or is
      // clicked, but this is an easy way to do it
      for (int i = 0; i < this->dataGridView2->Rows->Count; i++) {
        std::string* str = toStandardString(
      ...
      if (!dimensionName->empty()) {
        ...
        this->textBox7->Text = gcnew System::String(
            (*OpenGL->getDimensionName(currentIndex)).c_str());
      }

      if (this->checkBox1->Checked) {
        // create temporary string variable that way we can manage them when out
        // of scope
  ...
  System::Void applyCluster(System::Void) {
    if (OpenGL->uploadedFile()) {
      ...
      double a1 = System::Decimal::ToDouble(this->numericUpDown5->Value);
      double a2 = System::Decimal::ToDouble(this->numericUpDown9->Value);

      // textBox3 = cluster fatal error made by the incompitent frenchman Daniel
      // Ortyn (yes, that's right you heard that FRENCH!)
      ...
      if (!clusterName->empty()) {
        ...
        this->textBox3->Text = gcnew System::String(
            (*OpenGL->file->getClusterName(currentIndex)).c_str());
      }
      ...
      if (this->changedClusterColor) {
        ...
        OpenGL->file->setAlphaTwo(currentIndex, (a2 / 255.0));
        this->changedClusterColor = false;
        delete color;
      }
  ...
  System::Void applyClassSet(System::Void) {
    if (OpenGL->uploadedFile()) {
      ...
      if (OpenGL->uploadedFile()) {
        std::vector<int>* setIndexList =
            OpenGL->file->getSetsInClass(currentIndex);
  ...
  System::Void loadClass(System::Void) {
    ...
    cli::array<System::Object ^> ^ item1 =
        gcnew cli::array<System::Object ^>(OpenGL->getClassAmount());
    for (int i = 0; i < OpenGL->getClassAmount(); i++) {
      System::String ^ mString =
          gcnew System::String((*OpenGL->getClassName(i)).c_str());
      item1[i] = (Object ^) mString;
    }
    this->classComboBox->Items->AddRange(
        item1);  // set the combobox for "Class tab" to the data in item1
    this->comboBox1->Items->AddRange(
        item1);  // set the combobox for class assignment in "Set tab" to the
                 // data in item1
  ...
  System::Void loadSet(System::Void) {
    ...
    // Setup of the sets
    cli::array<System::Object ^> ^ item2 =
        gcnew cli::array<System::Object ^>(OpenGL->getSetAmount());
    for (int i = 0; i < OpenGL->getSetAmount(); i++) {
      System::String ^ mString =
          gcnew System::String((*OpenGL->getSetName(i)).c_str());
      item2[i] = (Object ^) mString;
    }
    this->comboBox2->Items->AddRange(
        item2);  // set the combobox to the data in items2
  }
  ...
  System::Void loadVisibleSets(System::Void) {
    ...
    std::vector<int>* setIndexList =
        OpenGL->file->getSetsInClass(this->comboBox5->SelectedIndex);
    int a = setIndexList->size();
    for (int i = 0; i < setIndexList->size(); i++) {
      System::String ^ temp = gcnew System::String(
          (*OpenGL->getSetName(setIndexList->at(i))).c_str());
  ...
  System::Void loadDimensions(System::Void) {
    ...
    cli::array<System::Object ^> ^ item3 =
        gcnew cli::array<System::Object ^>(OpenGL->getDimensionAmount());
    for (int i = 0; i < OpenGL->getDimensionAmount(); i++) {
      System::String ^ mString =
          gcnew System::String((*OpenGL->getDimensionName(i)).c_str());
      item3[i] = (Object ^) mString;
    }
    this->comboBox3->Items->AddRange(
        item3);  // set the combobox to the data in items3
  }
  ...
  System::Void loadClusters(System::Void) {
    ...
    // Setup of the dimensions
    cli::array<System::Object ^> ^ item4 =
        gcnew cli::array<System::Object ^>(OpenGL->getClusterAmount());
    for (int i = 0; i < OpenGL->getClusterAmount(); i++) {
      System::String ^ mString =
          gcnew System::String((*OpenGL->file->getClusterName(i)).c_str());
      item4[i] = (Object ^) mString;
    }
    this->comboBox4->Items->AddRange(
        item4);  // set the combobox to the data in items3
  }

 private:
  System::Void tabPage4_Click(System::Object ^ sender, System::EventArgs ^ e) {}
    ...
    if (OpenGL->uploadedFile()) {
      ...
      if (currentIndex > 0) {
        ...
        if (currentIndex < OpenGL->getClassAmount()) {
          this->classComboBox->SelectedIndex =
              currentIndex;  // set it to the last index and shows it
          System::String ^ temp = gcnew System::String(
              (*OpenGL->getClassName(currentIndex)).c_str());
          this->textBox5->Text = temp;
        } else if (currentIndex == OpenGL->getClassAmount()) {
          this->classComboBox->SelectedIndex =
              currentIndex - 1;  // set it to the last index and shows it
          System::String ^ temp = gcnew System::String(
              (*OpenGL->getClassName(currentIndex - 1)).c_str());
          this->textBox5->Text = temp;
        } else {
          // do nothing
        }
 ...
 private:
  System::Void nButtonControl3_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyClass();
  }

  // delete a cluster
 private:
  System::Void label16_Click(System::Object ^ sender, System::EventArgs ^ e) {
    if (OpenGL->uploadedFile()) {
      if (this->comboBox4->Items->Count > 0) {
        int currentIndex = this->comboBox4->SelectedIndex;
        ...
        if (currentIndex < this->comboBox4->Items->Count) {
          if (currentIndex == 0) {
            if (this->comboBox4->Items->Count == 0) {
              this->comboBox4->Text =
                  "select...";  // if there's only one element left then show
                                // select...
              this->textBox3->Text = "";
            } else {
              this->comboBox4->SelectedIndex =
                  currentIndex;  // set it to the last index and shows it
            }
          } else {
            this->comboBox4->SelectedIndex =
                currentIndex;  // set it to the next index and shows it
          }
        } else if (currentIndex == this->comboBox4->Items->Count) {
          if (this->comboBox4->Items->Count == 0) {
            this->comboBox4->Text = "select...";  // if there's only one element
                                                  // left then show select...
            this->textBox3->Text = "";
          } else {
            this->comboBox4->SelectedIndex =
                currentIndex - 1;  // set it to the last index and shows it
  ...
  // update the Red box
 private:
  System::Void numericUpDown8_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    ...
    System::Decimal a1 = this->numericUpDown5->Value;  // alpha 1
    System::Decimal a2 = this->numericUpDown9->Value;  // alpha 2
 ...
 private:
  System::Void numericUpDown7_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    System::Decimal r = this->numericUpDown8->Value;
    System::Decimal g = this->numericUpDown7->Value;
    System::Decimal b = this->numericUpDown6->Value;
  ...
  // update the blue box
 private:
  System::Void numericUpDown6_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    System::Decimal r = this->numericUpDown8->Value;
    System::Decimal g = this->numericUpDown7->Value;
    System::Decimal b = this->numericUpDown6->Value;
 ...
 private:
  System::Void numericUpDown5_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    System::Decimal r = this->numericUpDown8->Value;
    System::Decimal g = this->numericUpDown7->Value;
    System::Decimal b = this->numericUpDown6->Value;
 ...
 private:
  System::Void nHsbColorPickerControl2_SelectedColorChanged(
      Nevron::Nov::Dom::NValueChangeEventArgs ^ arg) {
    Nevron::Nov::Graphics::NColor selectedColor =
        (Nevron::Nov::Graphics::NColor)arg->NewValue;
 ...
 private:
  System::Void setSetIndexChanged_ChangeEvent(System::Object ^ sender,
                                              System::EventArgs ^ e) {
    System::String ^ temp = gcnew System::String(
        (*OpenGL->getSetName(this->comboBox2->SelectedIndex)).c_str());
 ...
 private:
  System::Void nButtonControl11_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->Close();
  }

 private:
  System::Void nButtonControl10_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyCluster();
  }

 private:
  System::Void nButtonControl12_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyCluster();
    this->Close();
  }

 private:
  System::Void nButtonControl7_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyDimension();
  }

 private:
  System::Void nButtonControl9_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyDimension();
    this->Close();
  }

 private:
  System::Void nButtonControl4_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applySet();
    this->loadVisibleSets();
  }

 private:
  System::Void nButtonControl6_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applySet();
    this->Close();
  }

 private:
  System::Void removeCluster_Hover(System::Object ^ sender,
                                   System::EventArgs ^ e) {
    this->label16->ForeColor = System::Drawing::Color::FromArgb(
        (int)200, (int)0, (int)0);  // somewhat dark green, like lawn green
  }

 private:
  System::Void removeCluster_Leave(System::Object ^ sender,
                                   System::EventArgs ^ e) {
    this->label16->ForeColor = System::Drawing::Color::Black;  // black
  }

 private:
  System::Void setClass_SelectedIndex_Change(System::Object ^ sender,
                                             System::EventArgs ^ e) {
    this->classSetSelectedIndexChanged = true;
  }

 private:
  System::Void checkedDimension_State(System::Object ^ sender,
                                      System::EventArgs ^ e) {
    if (this->checkBox1->Checked) {
      this->textBox1->Enabled = true;
      this->textBox2->Enabled = true;
 ...
 private:
  System::Void textBox1_KeyPress_State(
    ...
    if ((e->KeyChar == '.') &&
        safe_cast<TextBox ^>(sender)->Text->IndexOf('.') > -1) {
      e->Handled = true;
    }

    // only allow for one negative sign and only at the front of the numer
    if ((e->KeyChar == '-') &&
        safe_cast<TextBox ^>(sender)->SelectionStart != 0) {
      e->Handled = true;
    }

    if ((e->KeyChar == '-') &&
        safe_cast<TextBox ^>(sender)->SelectionStart == 0 &&
        safe_cast<TextBox ^>(sender)->Text->IndexOf('-') == 0) {
      e->Handled = true;
    }
 ...
 private:
  System::Void textBox2_KeyPress_State(
      System::Object ^ sender, System::Windows::Forms::KeyPressEventArgs ^ e) {
    if (!Char::IsControl(e->KeyChar) && !Char::IsDigit(e->KeyChar) &&
        (e->KeyChar != '.') && (e->KeyChar != '-')) {
      e->Handled = true;
 ...
 private:
  System::Void dataGridView2_KeyPressed_State(
      System::Object ^ sender, System::Windows::Forms::KeyPressEventArgs ^ e) {
    if (!Char::IsControl(e->KeyChar) && !Char::IsDigit(e->KeyChar) &&
        (e->KeyChar != '.') && (e->KeyChar != '-')) {
      e->Handled = true;
 ...
 private:
  System::Void dataGridView1_EditingControl(
      System::Object ^ sender,
      System::Windows::Forms::DataGridViewEditingControlShowingEventArgs ^ e) {
    e->Control->KeyPress -= gcnew KeyPressEventHandler(
        this, &Settings::dataGridView2_KeyPressed_State);
    TextBox ^ tb = safe_cast<TextBox ^>(e->Control);
    if (tb != nullptr) {
      tb->KeyPress += gcnew KeyPressEventHandler(
          this, &Settings::dataGridView2_KeyPressed_State);
    }
  }

 private:
  System::Void dataGridView2_CellValueChanged(
      System::Object ^ sender,
      System::Windows::Forms::DataGridViewCellEventArgs ^ e) {}

 private:
  System::Void classSetSelectedIndex_Changed(System::Object ^ sender,
                                             System::EventArgs ^ e) {
    if (OpenGL->uploadedFile()) {
      /*this->checkedListBox1->Items->Clear();
      std::vector<int>* setIndexList =
      OpenGL->file->getSetsInClass(this->comboBox5->SelectedIndex); for (int i =
      0; i < setIndexList->size(); i++) { int asdf = setIndexList->at(i);
      System::String^ temp = gcnew
      System::String((*OpenGL->getSetName(setIndexList->at(i))).c_str());
      this->checkedListBox1->Items->Add(temp,
      OpenGL->isVisible(setIndexList->at(i)));
      }*/
 ...
 private:
  System::Void nButtonControl14_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->Close();
  }

 private:
  System::Void nButtonControl15_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyClassSet();
    this->Close();
  }

 private:
  System::Void nButtonControl13_Click(Nevron::Nov::Dom::NEventArgs ^ arg) {
    this->applyClassSet();
  }
 ...
 private:
  System::Void nHsbColorPickerControl2_SelectedColorChanged_1(
      Nevron::Nov::Dom::NValueChangeEventArgs ^ arg) {
    Nevron::Nov::Graphics::NColor selectedColor =
        (Nevron::Nov::Graphics::NColor)arg->NewValue;
 ...
 private:
  System::Void nHsbColorPickerControl1_SelectedColorChanged_1(
      Nevron::Nov::Dom::NValueChangeEventArgs ^ arg) {
    Nevron::Nov::Graphics::NColor selectedColor =
        (Nevron::Nov::Graphics::NColor)arg->NewValue;
 ...
 private:
  System::Void comboBox4_SelectedIndexChanged(System::Object ^ sender,
                                              System::EventArgs ^ e) {
    if (OpenGL->uploadedFile()) {
      this->textBox3->Text = gcnew System::String(
          (*OpenGL->file->getClusterName(this->comboBox4->SelectedIndex))
              .c_str());
    }
  }

 private:
  System::Void numericUpDown9_ValueChanged(System::Object ^ sender,
                                           System::EventArgs ^ e) {
    System::Decimal r = this->numericUpDown8->Value;
    System::Decimal g = this->numericUpDown7->Value;
    System::Decimal b = this->numericUpDown6->Value;
